...
ScoreManager.prototype.set = function (score) {
...
GameManager.prototype.forEachConnection = function(callback) {
...
GameManager.prototype.reSetup = function () {
  var self = this;
...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    ...
    this.newTile = {x: tile.x, y: tile.y, value: tile.value};
  }
};
